...
⚠️  DO NOT EDIT THIS FILE. It carries the `openai/` model prefix and `max_retries`
wiring that CrewAI's provider routing depends on. Copy it as-is from the template.
"""
